...
const WeekView: React.FC<WeekViewProps> = ({
  ...
  // <-- ici tu appelles ton hook
  const { t } = useTranslation();
  const start = format(daysOfWeek[0], "d MMMM", { locale: fr });
  const end = format(daysOfWeek[6], "d MMMM yyyy", { locale: fr });
      ...
      >
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>
              {t("week_title_prefix")} {start} {t("week_title_middle")} {end}
            </CardTitle>
            <div className="flex items-center gap-2">
