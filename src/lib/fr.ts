export const translationsFR = {
  ...
  selection_tests_desc:
    "Demande d'inscription aux tests de sélection pour l'académie (U10-U21)",
  ...
  admin_rwdm: "Admin RWDM Brussels",
  ...
  footer_description:
    "La RWDM Brussels Academy est dédiée à la formation des jeunes talents du football belge. Nous nous engageons à offrir un environnement d'apprentissage de qualité.",
  ...
  auth_email_placeholder: "votre.email@rwdmbrussels.be",
  auth_password_label: "Mot de passe",
  auth_forgot_password: "Mot de passe oublié ?",
  auth_login_button: "Se connecter",
  auth_logging_in: "Connexion en cours...",
  auth_admin_note:
    "Cette page est réservée aux administrateurs de l'Académie RWDM Brussels.",
  ...
  signature_reminder_html:
    "<strong>Pour rappel :</strong> ce formulaire concerne une <u>demande d'inscription</u> à la RWDM Brussels Academy et ne constitue en aucun cas une inscription définitive. Vous recevrez une réponse dans les prochaines heures ou jours de la part de la direction, via l'adresse email que vous avez fournie.",
  label_date: "Date :",
  ...
  selection_signature_info:
    "La RWDM Brussels Academy décline toute responsabilité en cas d'incidents, d'accidents, de vols survenus dans ses installations et aux abords. En signant ce document, vous reconnaissez avoir pris connaissance de cette information.",
  ...
  category_U13: "U13",
  category_U14: "U14",
  category_U15_full: "U15 (disponible à la RWDM ForEver Academy)",
  category_U16: "U16",
  category_U17_full: "U17 (disponible à la RWDM ForEver Academy)",
  category_U18: "U18",
  category_U19_full: "U19 (disponible à la RWDM ForEver Academy)",
  category_U21: "U21",
  ...
  confidentiality_section1_text:
    "Bienvenue sur la plateforme RWDM Brussels Academy. Nous nous engageons à protéger la vie privée et les données personnelles des utilisateurs de notre service. Cette politique de confidentialité explique comment nous recueillons, utilisons, partageons et protégeons vos informations personnelles.",
  ...
  cgu_section1_text:
    "En envoyant des demandes via la plateforme RWDM Brussels Academy, vous acceptez d’être lié par les présentes Conditions Générales d’Utilisation. Si vous n’acceptez pas ces conditions, veuillez ne pas utiliser notre service.",
  cgu_section2_title: "2. Description du service",
  cgu_section2_text1:
    "La plateforme RWDM Brussels Academy permet d’envoyer des demandes pour :",
  cgu_section2_li1: "demande d’inscription à l’académie RWDM Brussels",
  ...
  cgu_section11_text:
    "Pour toute question, contactez : RWDM Brussels Academy, Rue Charles Malis 61, 1080 Molenbeek‑Saint‑Jean, {{email}}",
  cgu_section2_intro:
    "La plateforme RWDM Brussels Academy permet d’envoyer des demandes pour :",
  cgu_section2_item1: "demande d’inscription à l’académie RWDM Brussels",
  ...
  legal_section4_text:
    "Tout le contenu (textes, images, logos, etc.) est la propriété exclusive de RWDM Brussels Academy ou de ses partenaires. Toute reproduction ou adaptation sans autorisation écrite préalable est interdite.",
  ...
  "passwordReset.emailPlaceholder": "votre.email@rwdmbrussels.be",
  ...
  desktop_view_unavailable: "Vue non disponible",
  desktop_view_message:
    "Cette interface d'administration est uniquement accessible sur ordinateur.",
  "request_type.registration": "Inscription à l'académie",
  "request_type.selection_tests": "Tests de sélection",
  "request_type.accident_report": "Déclaration d'accident",
  "request_type.responsibility_waiver": "Décharge de responsabilité",
  ...
  "common.signature_date": "Date de signature",
  "common.unknown_request_type": "Type de demande non reconnu.",

  "request.id_and_date": "Demande #{id} • {date}",
  "request.submitted_on": "Soumis le",

  "registration.season_title": "Saison d'inscription",
  "registration.season": "Saison",
  "registration.academy": "Académie",
  "registration.player_info": "Informations du joueur",
  "registration.lastName": "Nom",
  "registration.firstName": "Prénom",
  "registration.birthDate": "Date de naissance",
  "registration.birthPlace": "Lieu de naissance",
  "registration.address": "Adresse",
  "registration.postalCode": "Code postal",
  "registration.city": "Ville",
  "registration.currentClub": "Club actuel",
  "registration.category": "Catégorie",
  "registration.primary_guardian": "Informations du responsable principal",
  "registration.guardian_type": "Type",
  "registration.phone": "Téléphone",
  "registration.email": "Email",
  "registration.gsm": "GSM",
  "registration.secondary_guardian": "Informations du responsable secondaire",
  "registration.image_consent": "Consentement à l'image",
  "registration.consent": "Consentement",
  "registration.consent_accepted":
    "J'accepte que des photos de mon enfant soient prises et utilisées à des fins promotionnelles.",
  "registration.consent_declined": "Non consenti",

  "selection.test_info": "Informations sur les tests",
  "selection.category": "Catégorie",
  "selection.academy": "Académie",
  "selection.player_info": "Informations du joueur",
  "selection.lastName": "Nom",
  "selection.firstName": "Prénom",
  "selection.birthDate": "Date de naissance",
  "selection.phone": "Téléphone (GSM)",
  "selection.email": "Email",
  "selection.currentClub": "Club actuel",
  "selection.previousClub": "Club précédent",
  "selection.position": "Position",
  "selection.guardian_info": "Informations des responsables légaux",
  "selection.relation": "Relation",

  "accident.info_title": "Informations sur l'accident",
  "accident.date": "Date de l'accident",
  "accident.academy": "Académie",
  "accident.playerLastName": "Nom du joueur",
  "accident.playerFirstName": "Prénom du joueur",
  "accident.email": "Adresse e-mail",
  "accident.phone": "Numéro de téléphone",
  "accident.codeDossier": "Code du dossier",
  "accident.documentLabel": "Type de document",
  "accident.description_title": "Description de l'accident",
  "accident.no_description": "Aucune description fournie.",
  "accident.supporting_documents": "Documents justificatifs",
  "accident.supporting_document": "Document justificatif",
  "accident.view_document": "Voir le document",
  "accident.view_pdf": "Voir le document PDF",
  "accident.data_consent":
    "En vue d'une gestion efficace de mon dossier, et uniquement à cet effet, je donne autorisation au traitement des données médicales me concernant relatives à l'accident dont j'ai été victime, comme décrit dans la \"Déclaration de confidentialité\".",

  "waiver.parent_info": "Informations du parent/tuteur",
  "waiver.lastName": "Nom",
  "waiver.firstName": "Prénom",
  "waiver.phone": "Téléphone",
  "waiver.email": "Email",
  "waiver.player_info": "Informations du joueur",
  "waiver.birthDate": "Date de naissance",
  ...
  "waiver.generate_pdf": "Générer PDF",
  "waiver.pdf_title": "Décharge de responsabilité",
  "waiver.pdf_filename": "Decharge_Responsabilite.pdf",
  "waiver.waiver_text_part1": "Je soussigné(e),",
  "waiver.waiver_text_part2": "représentant légal du joueur",
  "waiver.waiver_text_part3": "né(e) le",
  "waiver.waiver_text_part4": "et affilié(e) au club",
  "waiver.waiver_text_part5":
    "décharge la RWDM Brussels Academy de toute responsabilité en cas d'accident pouvant survenir au cours des entraînements et/ou matchs amicaux.",
  ...
  sidebar_refusals: "Refus",
  sidebar_union: "Envois Union Belge",
  ...
  "database.usage_title": "Utilisation de la base de données",
  "database.total_storage": "Stockage total",
  "database.pending_requests": "Demandes non terminées",
  "database.completed_requests": "Demandes terminées",
  "database.appointments": "Rendez-vous",
  "database.free_space": "Espace libre",
  "database.usage_label": "Utilisation",
  "database.total_capacity": "Capacité totale",
  "database.megabytes": "Mo",
  "database.chart_description":
    "Ces données représentent l'utilisation actuelle du stockage de la base de données par type de contenu.",
  "database.pending_requests_value": "Demandes non terminées: {value} Mo",
  "database.completed_requests_value": "Demandes terminées: {value} Mo",
  "database.appointments_value": "Rendez-vous: {value} Mo",
  "database.free_space_value":
    "Espace libre: {value} Mo et Utilisation: {value}%",
  "database.usage_percentage": "Utilisation: {value}%",
  "database.total_capacity_percentage": "Capacité totale: 100%",
  "database.fetch_error": "Erreur lors du chargement des données de stockage",
  "database.data_error": "Impossible de charger les données",
  "database.storage_settings": "Paramètres de stockage",
  "database.storage_settings_desc":
    "Configurez la capacité de stockage totale et le fournisseur d'hébergement",
  "database.total_capacity_mb": "Capacité totale (Mo)",
  "database.capacity_note":
    "Entrez la capacité totale que votre hébergeur vous alloue",
  "database.provider_name": "Nom de l'hébergeur",
  "database.update_settings": "Mettre à jour les paramètres",
  "database.updating_settings": "Mise à jour...",
  "database.settings_fetch_error": "Erreur de chargement",
  "database.settings_fetch_error_desc":
    "Impossible de charger les paramètres de stockage",
  "database.invalid_capacity": "Capacité invalide",
  "database.invalid_capacity_desc": "La capacité doit être un nombre positif",
  "database.invalid_provider": "Nom d'hébergeur invalide",
  "database.invalid_provider_desc": "Veuillez saisir un nom d'hébergeur valide",
  "database.settings_updated": "Paramètres mis à jour",
  "database.settings_updated_desc":
    "Les paramètres de stockage ont été mis à jour avec succès",
  "database.settings_update_error": "Erreur de mise à jour",
  "database.settings_update_error_desc":
    "Impossible de mettre à jour les paramètres de stockage",
  "database.host_info": "Informations d'hébergement",
  ...
  "guide.github_repo_link": "Accéder au repository RWDM Brussels Academy",
  ...
  "noElements.found": "trouvée.",
  "noElements.category": "Aucune facture trouvée pour la catégorie ",
  "category.rwdm_brussels_academy_sub":
  ...
  no_publications_match: "Aucune publication ne correspond à votre recherche.",
  no_publications_created: "Il n'y a actuellement aucune publication créée. Créez-en une pour commencer.",
  create_first_publication: "Créer la première publication",
  title_required: "Titre *",
  publication_description: "Description",
  image_required: "Image *",
  image_required_error: "Une image est requise",
  create_publication: "Créer",
  update_publication: "Mettre à jour",
  keep_current_image: "Laissez vide pour conserver l'image actuelle",
  status: "Statut:",
