export const translationsNL = {
  ...
  academy_registration_desc:
    "Inschrijvingsformulier om lid te worden van de Daring Brussels Academy (U5-U9)",
  ...
  footer_description:
    "De Daring Brussels Academy is toegewijd aan de opleiding van jong Belgisch voetbaltalent. Wij engageren ons om een kwaliteitsvolle leeromgeving te bieden.",
  ...
  auth_email_placeholder: "jouw.email@daringbrussels.be",
  ...
  auth_admin_note:
    "Deze pagina is alleen toegankelijk voor Daring Brussels Academy beheerders.",
  ...
  signature_reminder_html:
    "<strong>Ter herinnering :</strong> dit formulier betreft een <u>inschrijvingsaanvraag</u> bij de Daring Brussels Academy en vormt op geen enkele wijze een definitieve inschrijving. U ontvangt binnen enkele uren of dagen een reactie van de directie via het e-mailadres dat u hebt opgegeven.",
  label_date: "Datum :",
  ...
  selection_signature_info:
    "De Daring Brussels Academy is niet aansprakelijk voor incidenten, ongevallen of diefstal in of rond haar faciliteiten. Door te ondertekenen erkent u daarvan op de hoogte te zijn.",
  ...
  category_U13: "U13",
  category_U14: "U14",
  category_U15_full: "U15 (beschikbaar bij DB ForEver Academy)",
  category_U16: "U16",
  category_U17_full: "U17 (beschikbaar bij DB ForEver Academy)",
  category_U18: "U18",
  category_U19_full: "U19 (beschikbaar bij DB ForEver Academy)",
  category_U21: "U21",
  ...
  academy_RFE_provincial: "DB ForEver Academy (Provincialen)",
  ...
  waiver_text_template:
    "Ondergetekende, {{parentFirstName}} {{parentLastName}}, wettelijke vertegenwoordiger van de speler {{playerFirstName}} {{playerLastName}}, geboren op {{playerBirthDate}}, en aangesloten bij club {{currentClub}}, ontheft Daring Brussels Academy van alle verantwoordelijkheid in geval van een ongeval tijdens trainingen en/of vriendschappelijke wedstrijden waaraan de speler vanaf vandaag deelneemt.",
  ...
  confidentiality_section1_text:
    "Welkom op het DB Academy-platform. Wij zetten ons in voor de bescherming van de privacy en persoonsgegevens van de gebruikers van onze dienst. Dit privacybeleid legt uit hoe we uw persoonlijke gegevens verzamelen, gebruiken, delen en beschermen.",
  ...
  cgu_section1_text:
    "Door verzoeken via het Daring Brussels Academy‑platform te verzenden, stemt u in met deze Algemene Gebruiksvoorwaarden. Als u niet akkoord gaat, gebruik dan onze service niet.",
  cgu_section2_title: "2. Beschrijving van de dienst",
  cgu_section2_text1:
    "Het Daring Brussels Academy‑platform maakt het mogelijk om verzoeken in te dienen voor:",
  cgu_section2_li1: "inschrijvingsverzoek voor de Daring Brussels Academy",
  ...
  cgu_section11_text:
    "Voor vragen kunt u contact opnemen met: Daring Brussels Academy, Rue Charles Malis 61, 1080 Molenbeek‑Saint‑Jean, {{email}}",
  cgu_section2_intro:
    "Het Daring Brussels Academy-platform stelt u in staat om aanvragen in te dienen voor:",
  cgu_section2_item1: "aanvraag voor inschrijving bij de DB-academie",
  ...
  legal_section4_text:
    "Alle inhoud (teksten, afbeeldingen, logo’s, enz.) is exclusief eigendom van Daring Brussels Academy of haar partners. Elk gebruik zonder schriftelijke toestemming is verboden.",
  ...
  "passwordReset.emailPlaceholder": "uw.email@daringbrusselsacademy.be",
  ...
  appointments_archive_mode: "Archiveringsmodus",
  appointment_date: "Datum",
  appointment_time: "Tijd",
  appointment_type: "Type",
  appointment_client: "Klant",
  appointment_email: "E-mail",
  appointment_admin: "Beheerder",
  archive_success: "Archivering succesvol",
  archive_error: "Archiveringsfout",
  no_selected_appointments: "Geen geselecteerde afspraken",
  "Alle seizoenen": "Alle seizoenen",
  desktop_view_unavailable: "Weergave niet beschikbaar",
  desktop_view_message:
    "Deze beheerdersinterface is alleen toegankelijk op een computer.",
  "request_type.registration": "Inschrijving bij de academie",
  "request_type.selection_tests": "Selectietesten",
  "request_type.accident_report": "Ongevalaangifte",
  "request_type.responsibility_waiver": "Aansprakelijkheidsverklaring",
  ...
  "common.signature": "Handtekening",
  "common.signature_alt": "Handtekening",
  "common.signature_date": "Datum handtekening",
  "common.unknown_request_type": "Onbekend aanvraagtype.",

  "request.id_and_date": "Aanvraag #{id} • {date}",
  "request.submitted_on": "Ingediend op",

  "registration.season_title": "Inschrijvingsseizoen",
  "registration.season": "Seizoen",
  "registration.academy": "Academie",
  "registration.player_info": "Spelersinformatie",
  "registration.lastName": "Achternaam",
  "registration.firstName": "Voornaam",
  "registration.birthDate": "Geboortedatum",
  "registration.birthPlace": "Geboorteplaats",
  "registration.address": "Adres",
  "registration.postalCode": "Postcode",
  "registration.city": "Stad",
  "registration.currentClub": "Huidige club",
  "registration.category": "Categorie",
  "registration.primary_guardian": "Gegevens hoofdverantwoordelijke",
  "registration.guardian_type": "Type",
  "registration.phone": "Telefoon",
  "registration.email": "E-mail",
  "registration.gsm": "Mobiel",
  "registration.secondary_guardian": "Gegevens tweede verantwoordelijke",
  "registration.image_consent": "Toestemming beeldmateriaal",
  "registration.consent": "Toestemming",
  "registration.consent_accepted":
    "Ik ga ermee akkoord dat foto's van mijn kind worden genomen en gebruikt voor promotionele doeleinden.",
  "registration.consent_declined": "Geen toestemming",

  "selection.test_info": "Informatie over de testen",
  "selection.category": "Categorie",
  "selection.academy": "Academie",
  "selection.player_info": "Spelersinformatie",
  "selection.lastName": "Achternaam",
  "selection.firstName": "Voornaam",
  "selection.birthDate": "Geboortedatum",
  "selection.phone": "Telefoon (mobiel)",
  "selection.email": "E-mail",
  "selection.currentClub": "Huidige club",
  "selection.previousClub": "Vorige club",
  "selection.position": "Positie",
  "selection.guardian_info": "Gegevens wettelijke vertegenwoordigers",
  "selection.relation": "Relatie",

  "accident.info_title": "Informatie over het ongeval",
  "accident.date": "Datum van het ongeval",
  "accident.academy": "Academie",
  "accident.playerLastName": "Achternaam speler",
  "accident.playerFirstName": "Voornaam speler",
  "accident.email": "E-mailadres",
  "accident.phone": "Telefoonnummer",
  "accident.codeDossier": "Dossiernummer",
  "accident.documentLabel": "Documenttype",
  "accident.description_title": "Beschrijving van het ongeval",
  "accident.no_description": "Geen beschrijving verstrekt.",
  "accident.supporting_documents": "Ondersteunende documenten",
  "accident.supporting_document": "Ondersteunend document",
  "accident.view_document": "Document bekijken",
  "accident.view_pdf": "PDF-document bekijken",
  "accident.data_consent":
    'Ten behoeve van een efficiënte afhandeling van mijn dossier, en uitsluitend voor dit doel, geef ik toestemming voor de verwerking van mijn medische gegevens met betrekking tot het ongeval waarvan ik slachtoffer ben geworden, zoals beschreven in de "Privacyverklaring".',

  "waiver.parent_info": "Gegevens ouder/voogd",
  "waiver.lastName": "Achternaam",
  "waiver.firstName": "Voornaam",
  "waiver.phone": "Telefoon",
  "waiver.email": "E-mail",
  "waiver.player_info": "Spelersinformatie",
  "waiver.birthDate": "Geboortedatum",
  "waiver.currentClub": "Huidige club",
  "waiver.waiver_title": "Aansprakelijkheidsverklaring",
  "waiver.waiver_text":
    "Ik, ondergetekende {parentFirstName} {parentLastName}, wettelijk vertegenwoordiger van speler {playerFirstName} {playerLastName}, geboren op {playerBirthDate}, en aangesloten bij club {currentClub}, onthef de Daring Brussels Academy van alle aansprakelijkheid in geval van ongevallen die kunnen gebeuren tijdens trainingen en/of vriendschappelijke wedstrijden.",
  "waiver.date_confirmation": "Datum en bevestiging",
  "waiver.signatureDate": "Datum handtekening",
  "waiver.approvalText": "Vermelding",
  "waiver.generate_pdf": "PDF genereren",
  "waiver.pdf_title": "Aansprakelijkheidsverklaring",
  "waiver.pdf_filename": "Aansprakelijkheidsverklaring.pdf",
  "waiver.waiver_text_part1": "Ik, ondergetekende",
  "waiver.waiver_text_part2": "wettelijk vertegenwoordiger van speler",
  "waiver.waiver_text_part3": "geboren op",
  "waiver.waiver_text_part4": "en aangesloten bij club",
  "waiver.waiver_text_part5":
    "onthef de Daring Brussels Academy van alle aansprakelijkheid in geval van ongevallen die kunnen gebeuren tijdens trainingen en/of vriendschappelijke wedstrijden.",
  ...
  adminName: "Beheerder",
  notes: "Notities",
  sidebar_requests: "Aanvragen",
  sidebar_confirmations: "Bevestigingen",
  sidebar_refusals: "Weigeringen",
  sidebar_union: "Belgische Voetbalbond verzendingen",
  sidebar_appointments: "Afspraken",
  accident_notify: "Ongeval melding (Bond)",
  healing_notify: "Herstel melding (Bond)",
  rejection: "Afwijzing",
  "api.settings.title": "API-instellingen Pro Soccer Data",
  "api.settings.description":
    "Wijzig de verbindingsinformatie voor de Pro Soccer Data API.",
  "api.settings.baseUrl": "API URL",
  "api.settings.clubKey": "Club sleutel",
  "api.settings.apiKey": "API sleutel",
  "api.settings.apiSecret": "API geheim (bearer token)",
  "api.settings.secretNote":
    "Laat dit veld leeg om het huidige geheim te behouden.",
  "api.settings.loadError": "Laadfout",
  "api.settings.loadErrorDetails": "Kan de API-instellingen niet laden.",
  "api.settings.saveSuccess": "Instellingen opgeslagen",
  "api.settings.saveError": "Opslagfout",
  "api.settings.saveErrorDetails": "Kan de API-instellingen niet opslaan.",
  "api.settings.validationError": "Verplichte velden",
  "api.settings.requiredFields": "Vul alle verplichte velden in.",
  "api.settings.testConnection": "Verbinding testen",
  "api.settings.testing": "Test bezig...",
  "api.settings.testSuccess": "Verbinding geslaagd",
  "api.settings.testFailed": "Verbinding mislukt",
  "api.settings.testError": "Testfout",
  "api.settings.testErrorDetails": "Kan de API-verbinding niet testen.",
  "api.success":
    "Succesvolle verbinding met Pro Soccer Data! Je API-instellingen werken correct.",
  "contactForm.emailDisclaimer":
    "Deze e-mail wordt alleen gebruikt voor weergave op de website en wijzigt niet het platformadres voor het verzenden van e-mails.",
  "auth.accessBlocked": "Toegang geblokkeerd",
  "auth.tokenError": "Tokenfout",
  "maintenance.toggled": "Onderhoudsmodus gewijzigd",
  "maintenance.enabled": "actief",
  "maintenance.disabled": "inactief",
  "maintenance.toggleError": "Fout bij het wijzigen van de onderhoudsmodus",
  "settings.saveSuccess": "Instellingen opgeslagen",
  "settings.serverError": "Serverfout",
  ...
  database: "Database",
  "database.usage_title": "Databasegebruik",
  "database.total_storage": "Totale opslag",
  "database.pending_requests": "Niet-voltooide aanvragen",
  "database.completed_requests": "Voltooide aanvragen",
  "database.appointments": "Afspraken",
  "database.free_space": "Vrije ruimte",
  "database.usage_label": "Gebruik",
  "database.total_capacity": "Totale capaciteit",
  "database.megabytes": "MB",
  "database.chart_description":
    "Deze gegevens vertegenwoordigen het huidige databaseopslaggebruik per inhoudstype.",
  "database.pending_requests_value": "Openstaande verzoeken: {value} MB",
  "database.completed_requests_value": "Voltooide verzoeken: {value} MB",
  "database.appointments_value": "Afspraken: {value} MB",
  "database.free_space_value": "Vrije ruimte: {value} MB en Gebruik: {value}%",
  "database.usage_percentage": "Gebruik: {value}%",
  "database.total_capacity_percentage": "Totale capaciteit: 100%",
  "database.fetch_error": "Fout bij het laden van opslaggegevens",
  "database.data_error": "Kan gegevens niet laden",
  "database.storage_settings": "Opslaginstellingen",
  "database.storage_settings_desc":
    "Configureer de totale opslagcapaciteit en hostingprovider",
  "database.total_capacity_mb": "Totale capaciteit (MB)",
  "database.capacity_note":
    "Voer de totale capaciteit in die uw hostingprovider toewijst",
  "database.provider_name": "Naam hostingprovider",
  "database.update_settings": "Instellingen bijwerken",
  "database.updating_settings": "Bijwerken...",
  "database.settings_fetch_error": "Laadfout",
  "database.settings_fetch_error_desc": "Kan opslaginstellingen niet laden",
  "database.invalid_capacity": "Ongeldige capaciteit",
  "database.invalid_capacity_desc": "Capaciteit moet een positief getal zijn",
  "database.invalid_provider": "Ongeldige providernaam",
  "database.invalid_provider_desc":
    "Voer een geldige naam van de hostingprovider in",
  "database.settings_updated": "Instellingen bijgewerkt",
  "database.settings_updated_desc":
    "Opslaginstellingen zijn succesvol bijgewerkt",
  "database.settings_update_error": "Fout bij bijwerken",
  "database.settings_update_error_desc":
    "Kan opslaginstellingen niet bijwerken",
  "database.host_info": "Hosting informatie",
  ...
  "guide.github_repo_link": "Toegang tot Daring Brussels Academy repository",
  ...
  meta_description:
    "Krijg toegang tot de officiële formulieren van de Daring Brussels Academy: registratie, selectietesten, vrijwaringsverklaring, ongevalaangifte en genezingscertificaat.",
};
